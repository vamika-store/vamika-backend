package com.vamikastore.vamika.mapper;
...
public class ProductMapper {
    ...
    public List<ProductResourceDto> mapProductResourcesListDto(List<Resources> resources) {
        return resources.stream().map(this::mapResourceDto).toList();
    }

    private ProductResourceDto mapResourceDto(Resources resources) {
